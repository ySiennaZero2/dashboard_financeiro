...
def convert_to_text(month):
    list1 = ['Ano Todo','Janeiro','Fevereiro','Março','Abril','Maio','Junho','Julho',
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            ...
                            html.Legend("Created by Collaço")
                        ])
                    ], style={'margin-top': '10px'}),
                    dbc.Row([
                        dbc.Button("Visit my profile", href="https://www.instagram.com/ysiennazero2/", target="_blank")
                    ], style={'margin-top': '10px'})
                ])
            ], style=tab_card)
        ], sm=4, lg=2),
